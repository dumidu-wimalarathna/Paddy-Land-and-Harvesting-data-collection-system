...
Class District extends CI_Controller {
    ...
    public function view() {
        ...
        $this->load->view('adminpanel/masterdata/district_view',$data);
    ...
    public function add() {
        ...
        $data['list_data'] = $this->Masterdata_model->get_all_details($this->table_name,'ID','DESC');
        $data['title'] ='Add a new Distric';
        $data['province_data'] = $this->Masterdata_model->populate_dropdown('province','ID','province_name','asc');
    ...
    public function save_district() {
        ...
        if ($this->form_validation->run()) {
            ...
            $recID = $this->input->post('ID', TRUE);
                ...
                $res =$this->Masterdata_model->save_district($save_status,$recID);
                if ($res) {
                    $this->session->set_flashdata('message_saved', ' Saved successfully.');
                    redirect(base_url() . 'adminpanel/masterdata/district/view');
            ...
            $this->session->set_flashdata('message_error', 'Save fail');
            redirect(base_url() . 'adminpanel/masterdata/district/add');           
        }
    }
