...
Class Province extends CI_Controller {
    ...
    public function view() {
        ...
        $this->load->view('adminpanel/masterdata/province_view',$data);
    ...
    public function save_province() {
        ...
        if ($this->form_validation->run()) {
            ...
            $recID = $this->input->post('ID', TRUE);
                ...
                $res =$this->Masterdata_model->save_province($save_status,$recID);
                if ($res) {
                    $this->session->set_flashdata('message_saved', ' Saved successfully.');
                    redirect(base_url() . 'adminpanel/masterdata/province/view');
            ...
            $this->session->set_flashdata('message_error', 'Save fail');
            redirect(base_url() . 'adminpanel/masterdata/province/add');           
        }
    }
