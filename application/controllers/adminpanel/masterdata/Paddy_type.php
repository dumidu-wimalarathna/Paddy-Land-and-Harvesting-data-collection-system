...
Class Paddy_type extends CI_Controller {

    private $table_name = "paddy_type";
    ...
    public function view() {
        ...
        $this->load->view('adminpanel/masterdata/paddy_type_view',$data);
    ...
    public function save_paddy_type() {
        
        $save_status = $this->input->post('cSaveStatus', TRUE);
        
        $this->form_validation->set_rules('paddy_type_name', 'paddy type name', 'required|trim');
        ...
        if ($this->form_validation->run()) {
            ...
            $recID = $this->input->post('ID', TRUE);
                ...
                $res =$this->Masterdata_model->save_paddy_type($save_status,$recID);
                if ($res) {
                    $this->session->set_flashdata('message_saved', ' Saved successfully.');
                    redirect(base_url() . 'adminpanel/masterdata/paddy_type/view');
            ...
            $this->session->set_flashdata('message_error', 'Save fail');
            redirect(base_url() . 'adminpanel/masterdata/paddy_type/add');           
        }
    }
