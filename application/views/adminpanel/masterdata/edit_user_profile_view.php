                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <section class="col col-6">
                                                                          ...
                                                                          <label class="input"> <i class="icon-append fa fa-lock"></i>
                                                                            <input type="password" name="pPasswordold" id="pPasswordold" value="<?php //echo $vName ?>">
                                                                          </label>
                                                                        </section>
                                                                      ...
                                                                      <div class="row">
                                                                        ...
                                                                        <section class="col col-6">
                                                                         <label class="label">New Password</label>
                                                                          ...
                                                                          <label class="input"> <i class="icon-append fa fa-lock"></i>
                                                                              <input type="password" name="pPassword" id="pPassword" value="<?php //echo $vContactPerson?>">
                                                                        ...
                                                                        <section class="col col-6">
                                                                         <label class="label">Retype Password</label>
                                                                          <label class="input"> <i class="icon-append fa fa-lock"></i>
                                                                            <input type="password" name="cPassword" id="cPassword" value="<?php //echo $vEmail?>">
                                                                          </label>
                                                                        </section>
