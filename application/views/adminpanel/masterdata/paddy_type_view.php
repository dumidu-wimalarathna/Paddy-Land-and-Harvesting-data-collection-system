            ...
            <div class="col-lg-8">                
                <ul id="sparks" class="">
                    ...
                    <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 22px 15px; min-width: auto;">
                        <a href="<?php echo base_url("adminpanel/masterdata/paddy_type/add"); ?>"><h5>Add New</h5></a>
                        
                    </li>
                    <?php } ?>
                    <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto;">
                        <a href="<?php echo base_url("adminpanel/masterdata/paddy_type/view"); ?>"><h5>View All<span class="txt-color-blue" style="text-align: center"><i class=""></i><?php echo count($list_data); ?></span></h5></a>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list_data as $rowlist) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $rowlist->paddy_type_name; ?></td>
                                                   
                                                   <?php if($UserType!=3){ ?>
                                                    <td align='center'> 
                                                        <div class="control-buttons" style="font-size: 15px;">  
                                                            <a href="<?php echo base_url("adminpanel/masterdata/paddy_type/edit/$recordid"); ?>" title="Modify"><i class="glyphicon glyphicon-edit"></i></a>
                                                        </div>
                                                    </td>

                                                    <td align='center'> 
                                                        <div class="control-buttons" style="font-size: 15px;">  
                                                            <a href="<?php echo base_url("adminpanel/masterdata/paddy_type/delete/$recordid"); ?>" title="Modify"><i class="glyphicon glyphicon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <script type="text/javascript">
                                                            ...
                                                            $('#inline_<?php echo $recordid; ?>').on('change', function (e) {
                                                                if ($(this).prop('checked')) {
                                                                    window.location.href = '<?php echo base_url("adminpanel/masterdata/paddy_type/active_record/$recordid"); ?>';
                                                                } else {
                                                                    window.location.href = '<?php echo base_url("adminpanel/masterdata/paddy_type/deactive_record/$recordid"); ?>';
                                                                }
                                                            });
            ...
            <div class="jarviswidget" id="user_register" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <form action="<?php echo base_url("adminpanel/masterdata/paddy_type/save_paddy_type"); ?>" method="post" id="event-form" class="smart-form" enctype="multipart/form-data">
                            <header>
                                <?php echo $title; ?>
                            </header>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-6">
                                        <label class="label">Paddy Type Name</label>
                                        <label class="input">
                                            <input type="text" name="paddy_type_name" id="paddy_type_name" value="<?php echo $paddy_type_name; ?>">
                                        </label>
                                    </section>
                                </div>
