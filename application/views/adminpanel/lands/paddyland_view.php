...
if ($saveStatus == 'E') {
    $ID = $edit_data[0]->ID;
    $land_owner_ID = $edit_data[0]->land_owner_ID;
    $land_name = $edit_data[0]->land_name;
    $land_extend = $edit_data[0]->land_extend;
            ...
            <div class="col-lg-8">                
                <ul id="sparks" class="">
                    ...
                    <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 22px 15px; min-width: auto;">
                        <a href="<?php echo base_url("adminpanel/lands/paddyland/add"); ?>"><h5>Add New</h5></a>
                        
                    </li>
                    <?php } ?>
                    <li class="sparks-info" style="border: 1px solid #c5c5c5; padding-right: 0px; padding: 10px; min-width: auto;">
                        <a href="<?php echo base_url("adminpanel/lands/paddyland/view"); ?>"><h5>View All<span class="txt-color-blue" style="text-align: center"><i class=""></i><?php echo count($list_data); ?></span></h5></a>
                                    ...
                                    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($list_data as $rowlist) {
                                                $recordid = $rowlist->ID;
                                                $land_owner_name= $rowlist->first_name.' '.$rowlist->last_name;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $ID; ?></td>
                                                    <td><?php echo $land_owner_name; ?></td>
                                                   ...
                                                   <?php if($UserType!=3){ ?>
                                                    <td align='center'> 
                                                        <div class="control-buttons" style="font-size: 15px;">  
                                                            <a href="<?php echo base_url("adminpanel/lands/paddyland/edit/$recordid"); ?>" title="Modify"><i class="glyphicon glyphicon-edit"></i></a>
                                                        </div>
                                                    </td>

                                                    <td align='center'> 
                                                        <div class="control-buttons" style="font-size: 15px;">  
                                                            <a href="<?php echo base_url("adminpanel/lands/paddyland/delete/$recordid"); ?>" title="Modify"><i class="glyphicon glyphicon-trash"></i></a>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <script type="text/javascript">
                                                            ...
                                                            $('#inline_<?php echo $recordid; ?>').on('change', function (e) {
                                                                if ($(this).prop('checked')) {
                                                                    window.location.href = '<?php echo base_url("adminpanel/lands/paddyland/active_record/$recordid"); ?>';
                                                                } else {
                                                                    window.location.href = '<?php echo base_url("adminpanel/lands/paddyland/deactive_record/$recordid"); ?>';
                                                                }
                                                            });
            ...
            <div class="jarviswidget" id="user_register" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <form action="<?php echo base_url("adminpanel/lands/paddyland/save_paddyland"); ?>" method="post" id="event-form" class="smart-form" enctype="multipart/form-data">
                            <header>
                               Add a new Paddy Land
                            </header>
                            ...
                            <fieldset>
                                <div class="row">
                                    ...
                                    <section class="col col-4">
                                        <label class="label">Land Owner Name</label>
                                        <label class="select state-success">
                                            <select id="land_owner_ID" name="land_owner_ID" aria-invalid="false" class="valid">
                                                <option value="">Please Select</option>
                                                <?php
                                                foreach ($owner_data as $row) {

                                                    $own_id = $row->ID;
                                                    $own_name = $row->first_name.' '.$row->last_name;

                                                    if ($land_owner_ID == $own_id) {
                                                        $select_own_name = 'selected = selected';
                                                    } else {
                                                        $select_own_name = '';
                                                    }

                                                    echo "<option value=\"$own_id\" $select_own_name>$own_name</option>";
                                                }
                                                ?>
                                            </select> <i></i>
                                        </label>
                                    ...
                                    <section class="col col-4">
                                        <label class="label">Land Name</label>
                                        <label class="input">
                                            <input type="text" name="land_name" id="land_name" value="<?php echo $land_name; ?>">
                                        </label>
                                    </section>

                                    <section class="col col-4">
                                        <label class="label">Land Extend</label>
                                        <label class="input">
                                            <input type="text" name="land_extend" id="land_extend" value="<?php echo $land_extend; ?>">
                                        </label>
                                    </section>
