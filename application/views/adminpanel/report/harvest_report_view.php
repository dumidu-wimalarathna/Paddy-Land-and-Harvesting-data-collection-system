            ...
            <div class="jarviswidget" id="user_register" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false" role="widget">
                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                        ...
                        <form action="<?php echo base_url("adminpanel/report/harvest_report/view"); ?>" method="post" id="event-form" class="smart-form" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                     ...
                                     <section class="col col-4">
                                        ...
                                        <label class="select state-success">
                                            <select id="year" name="year" aria-invalid="false" class="valid">
                                                ...
                                                for ($x = date('Y'); $x >= date('Y')-10; $x--) {
                                                    ...
                                                    echo "<option value=\"$x\" $select_ptype_name>$x</option>";
                                                }
                                                ?>
                                            </select> <i></i>
                                        </label>
                                      ...
                                      <section class="col col-4">
                                        ...
                                        <label class="select state-success">
                                            ...
                                            <select id="district" name="district" aria-invalid="false" class="valid">
                                                <option value="">Please Select</option>
                                                <?php
                ...
                <div class="row">
                    ...
                    <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="jarviswidget jarviswidget-color-darken" id="user_types" data-widget-editbutton="false">
                            ...
                            <footer>
                                <a href="get_havest_report" target="_blank">
